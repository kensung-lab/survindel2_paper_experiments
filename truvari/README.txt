...
echo Manta recall `grep recall manta-DUP-recall-HG00512/summary.txt | awk '{printf "%.2f",$2}'`
echo Manta precision `grep prec manta-DUP-precision-HG00512/summary.txt | awk '{printf "%.2f",$2}'`
